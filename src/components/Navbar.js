...
export default function Navbar() {
  ...
  const currentActiveLink = pathname === "/" ? "home" : "";
  ...
  const getDropdownParentClass = (name) => {
    ...
    const isMainMenuActive = currentActiveMainMenu === name;
  ...
  const getLinkClass = (section) =>
    pathname === "/" && (activeLink === section || section === "home")
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-12 items-center">
          ...
          >
            ...
            <div className="relative">
              <button
                ...
                className={getDropdownParentClass("tentang")}
              >
                Tentang Kami{" "}
                <i
                  className={`fas fa-chevron-down ml-1 text-xs transition-transform duration-300 ${activeDropdown === "tentang" ? "rotate-180" : ""}`}
                ></i>
              </button>
              <AnimatePresence>
            ...
            <div className="relative">
              <button
                ...
                className={getDropdownParentClass("layanan")}
              >
                Layanan Kami{" "}
                <i
                  className={`fas fa-chevron-down ml-1 text-xs transition-transform duration-300 ${activeDropdown === "layanan" ? "rotate-180" : ""}`}
                ></i>
              </button>
              <AnimatePresence>
            ...
            <div className="relative">
              <button
                onClick={() => toggleDropdown("kolab")}
                className={getDropdownParentClass("kolab")}
              >
                Kolaborasi{" "}
                <i
                  className={`fas fa-chevron-down ml-1 text-xs transition-transform duration-300 ${activeDropdown === "kolab" ? "rotate-180" : ""}`}
                ></i>
              </button>
              <AnimatePresence>
            ...
            <Link
              ...
              className={`transition font-medium ${currentActiveMainMenu === "berita" ? "text-primary font-bold dark:text-green-400" : "text-secondary hover:text-primary dark:text-gray-200 dark:hover:text-green-400"}`}
            >
              Berita
            </Link>
          ...
          <div className="flex items-center gap-2 md:hidden">
            <motion.button
              onClick={toggleTheme}
              className="p-2 text-gray-600 dark:text-yellow-300"
              whileTap={{ rotate: 180 }}
            >
              {theme === "dark" ? (
                <i className="fas fa-sun text-lg"></i>
            ...
            <button className="p-2" onClick={() => setIsOpen(!isOpen)}>
              <i
                className={`fas ${isOpen ? "fa-times" : "fa-bars"} fa-lg text-secondary dark:text-white transition-transform duration-300 ${isOpen ? "rotate-90" : ""}`}
              ></i>
            </button>
          </div>
        </div>
            ...
            <div className="pb-8 pt-2">
              ...
              <div className="border-b dark:border-gray-700">
                <button
                  ...
                  className={`flex justify-between items-center w-full text-left px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 ${currentActiveMainMenu === "tentang" ? "text-primary font-bold dark:text-green-400" : "text-secondary dark:text-gray-200"}`}
                >
                  <span>Tentang Kami</span>
                  <i
                    className={`fas fa-chevron-down text-xs transition-transform duration-300 ${mobileOpenDropdown === "tentang" ? "rotate-180" : ""}`}
                  ></i>
                </button>
                <AnimatePresence>
              ...
              <div className="border-b dark:border-gray-700">
                <button
                  ...
                  className={`flex justify-between items-center w-full text-left px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 ${currentActiveMainMenu === "layanan" ? "text-primary font-bold dark:text-green-400" : "text-secondary dark:text-gray-200"}`}
                >
                  <span>Layanan Kami</span>
                  <i
                    className={`fas fa-chevron-down text-xs transition-transform duration-300 ${mobileOpenDropdown === "layanan" ? "rotate-180" : ""}`}
                  ></i>
                </button>
                <AnimatePresence>
              ...
              <div className="border-b dark:border-gray-700">
                <button
                  ...
                  className={`flex justify-between items-center w-full text-left px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 ${currentActiveMainMenu === "kolab" ? "text-primary font-bold dark:text-green-400" : "text-secondary dark:text-gray-200"}`}
                >
                  <span>Kolaborasi</span>
                  <i
                    className={`fas fa-chevron-down text-xs transition-transform duration-300 ${mobileOpenDropdown === "kolab" ? "rotate-180" : ""}`}
                  ></i>
                </button>
                <AnimatePresence>
